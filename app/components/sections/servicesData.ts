/**
 * Data for the 'Our Services' section.
 */
...
export const services: Service[] = [
  ...
  },
  {
    ...
    description: "Strategic digital marketing campaigns that increase visibility and drive targeted traffic.",
    icon: "marketing",
  },
  {
    id: 6,
    title: "Multilingual Support",
    description: "Professional multilingual content and support in English, Swedish, and Amharic for global reach.",
    icon: "language",
  },
];